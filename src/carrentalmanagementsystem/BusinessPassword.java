 ...
 * @author Xristos
 */
public class BusinessPassword extends javax.swing.JFrame {

    /**
     * Creates new form BusinessPassword
     */
    ...
    private void initComponents() {
        ...
        menu_label.setText("Business Password");
        ...
        menu_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/closed.png"))); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(confirmpasswordlabel, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(confirmpassword, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE))))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(65, 65, 65)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(newpasswordlabel, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(newpassword, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(65, 65, 65)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(confirmpasswordlabel, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void newpasswordFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_newpasswordFocusLost
        ...
        {
            newpassword.setText("password");
            newpassword.setForeground(new Color(153,153,153));
        }
    ...
    private void changepasswordbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changepasswordbuttonActionPerformed
        String oldp = String.valueOf(password.getPassword());
        String newp = String.valueOf(newpassword.getPassword());
        String confirmp = String.valueOf(confirmpassword.getPassword());
        ...
        if(verifyFields())
        {
                ...
                ResultSet st,ts;
                String registerUserQuery = "SELECT * FROM `business_password` WHERE `password` = ?";
                    ...
                    st = ps.executeQuery();
                     ...
                     if(st.next()){
                            if(!newp.equals(confirmp))
                            {
                                ...
                                String Query = "INSERT INTO `business_password`(`password`) VALUES (?)";
                                
                                try {
                    
                                        ps = CarRentalManagementSystem.getConnection().prepareStatement(Query);
                                        ps.setString(1,newp);
                                        ...
                                        if(ps.executeUpdate() != 0){
                                               ...
                                               JOptionPane.showMessageDialog(null, "Business Password Changed");
                                               //open menu form
                                                BusinessPassword form = new BusinessPassword();
                                            ...
                                            Logger.getLogger(BusinessPassword.class.getName()).log(Level.SEVERE, null, ex);
                                            }
    ...
    public boolean verifyFields()
    {
        ...
        //check for empty fields        if( oldp.trim().equals("passwpr") || newp.trim().equals("")
        if(
               oldp.trim().equals("password") || newp.trim().equals("password")
                || confirmp.trim().equals("password")  )
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusinessPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusinessPassword().setVisible(true);
            }
        });
    }
