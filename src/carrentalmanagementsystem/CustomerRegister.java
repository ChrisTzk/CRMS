...
public class CustomerRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fullname_field.setForeground(new java.awt.Color(153, 153, 153));
        fullname_field.setText("fullname");
        fullname_field.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                fullname_fieldFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                fullname_fieldFocusLost(evt);
            }
        });
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(backtext, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(179, 179, 179))))))
        );
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(fullname_field, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)))
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(62, 62, 62)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(backtext, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
    ...
    private void register_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_register_buttonActionPerformed
        ...
        if(verifyFields())
        {
            if(!checkUsername(username))
            {
                ...
                ResultSet st;
                String registerUserQuery = "INSERT INTO `customer`( `username`, `fullname`, `password`, `phone`, `address`) VALUES (?,?,?,?,?)";
    ...
    private void fullname_fieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_fullname_fieldFocusGained
        // clear the textfield on focus if the text is "fullname"
        if(fullname_field.getText().trim().toLowerCase().equals("fullname"))
        {
            fullname_field.setText("");
            fullname_field.setForeground(Color.black);
        }
    }//GEN-LAST:event_fullname_fieldFocusGained

    private void fullname_fieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_fullname_fieldFocusLost
        // if the text field is equal to "fullname" or empty, set the "fullname" text
        //in the empty field on focus lost event
        if(fullname_field.getText().trim().equals("") || fullname_field.getText().trim().toLowerCase().equals("fullname"))
        {
            fullname_field.setText("fullname");
            fullname_field.setForeground(new Color(153,153,153));
        }
    }//GEN-LAST:event_fullname_fieldFocusLost
    ...
    private void backiconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backiconMouseClicked
        CustomerLogin lf = new CustomerLogin();
        lf.setVisible(true);
        lf.pack();
