 ...
 * @author Xristos
 */
public class MenuEmployee2 extends javax.swing.JFrame {

    /**
     * Creates new form MenuEmployee2
     */
    public MenuEmployee2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/number (4).png"))); // NOI18N
    ...
    private void customer_iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customer_iconMouseClicked
        CustomerTable2 lf = new CustomerTable2();
        lf.setVisible(true);
        lf.pack();
        lf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuEmployee2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuEmployee2().setVisible(true);
            }
        });
    }
