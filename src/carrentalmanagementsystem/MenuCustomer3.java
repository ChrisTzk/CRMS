 ...
 * @author Xristos
 */
public class MenuCustomer3 extends javax.swing.JFrame {

    /**
     * Creates new form MenuCustomer3
     */
    public MenuCustomer3() {
        initComponents();
    ...
    private void car_iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_car_iconMouseClicked
        CarsTableCustomer3 lf = new CarsTableCustomer3();
        lf.setVisible(true);
        lf.pack();
        lf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCustomer3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCustomer3().setVisible(true);
            }
        });
    }
