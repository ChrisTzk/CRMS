 ...
 * @author Xristos
 */
public class MenuCustomer2 extends javax.swing.JFrame {

    /**
     * Creates new form MenuCustomer2
     */
    public MenuCustomer2() {
        initComponents();
    ...
    private void car_iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_car_iconMouseClicked
        CarsTableCustomer2 lf = new CarsTableCustomer2();
        lf.setVisible(true);
        lf.pack();
        lf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCustomer2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCustomer2().setVisible(true);
            }
        });
    }
